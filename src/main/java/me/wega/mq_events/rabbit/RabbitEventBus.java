...
public final class RabbitEventBus<E extends RabbitEvent> {
    ...
    @SuppressWarnings({"unchecked"})
    public <T extends E> void subscribe(final @NotNull Class<T> event, RabbitEventConfig<? super T> config, final @NotNull EventSubscriber<? super T> subscriber) throws IOException {
